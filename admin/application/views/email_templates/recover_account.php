                            ...
                            <tr>
                                <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
                                    <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                        <tr>
                                            <td>
                                                <p>Dear <?php echo $userName; ?>,</p><br/>
                                                <p>Your new password is <b> <?php echo $new_password; ?></b></p>
                                                <p>Please use this password for login and after that you can change it.</p>
                                                <br/>
                                                <p>Please don't share it with others for security purpose.</p>
                                                <br/>
                                                <p>Many thanks !</p>
                                                <br/>
                                                <hr/>
                                                <p>This is system generated email. please don't send reply email on it.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
