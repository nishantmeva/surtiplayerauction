                            ...
                            <tr>
                                <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
                                    <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                        ...
                                        <tr>
                                            <td align='center' valign='top'>
                                                <h4 style='color: #49bf67 !important'>Account confirmation</h4>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align='center' style='border-top: 1px solid #dce1e5;border-bottom: 1px solid #dce1e5;' valign='top'>
                                                ...
                                                <p style='margin: 1em 0;'>
                                                    ...
                                                    <span style="color: #000000 !important;"><?= $email ?></span>                                                    
                                                </p>
                                                <p>
                                                    <strong>Unique ID:</strong>
                                                    <span style="color: #000000 !important;"><?= $unique_id ?></span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align='center' bgcolor='#49bf67' valign='top'>
                                                <h3><a href="<?= $verification_link ?>" style="color: #ffffff !important">Click here to confirm your account</a></h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align='center' valign='top'>
